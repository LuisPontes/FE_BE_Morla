...
CREATE TABLE `tb_separadores` (
  ...
  `last_up_string` varchar(255) DEFAULT NULL,
  `file_datas` tinyblob,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_separadores` VALUES (11,'ului','uilil','ului','2018-08-21 17:20:03',NULL,NULL);
...
-- Dump completed on 2018-08-21 18:26:10
